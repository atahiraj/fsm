...
// Preconditions: Executor, OnExitAny, OnEnterAny, OnExit, and OnEnter are non-nil.
...
// Preconditions: cfg.Executor, cfg.OnExitAny, cfg.OnEnterAny, cfg.OnExit, and cfg.OnEnter are non-nil.
