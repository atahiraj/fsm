...
// New creates an empty DFA builder.
func New[State comparable, Symbol comparable]() *Builder[State, Symbol] {
...
func (b *Builder[State, Symbol]) Build() (*dfa.DFA[State, Symbol], error) {
	...
	return dfa.New(dfa.Config[State, Symbol]{
...
func (b *Builder[State, Symbol]) BuildAtomic() (*dfaatomic.DFA[State, Symbol], error) {
	d, err := b.Build()
	if err != nil {
		return nil, err
	}
