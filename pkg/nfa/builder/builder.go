...
func (b *Builder[State, Symbol]) BuildAtomic() (*nfaatomic.NFA[State, Symbol], error) {
	n, err := b.Build()
	if err != nil {
		return nil, err
	}
...
// New creates an empty NFA builder.
...
func (b *Builder[State, Symbol]) Build() (*nfa.NFA[State, Symbol], error) {
	...
	return nfa.New(nfa.Config[State, Symbol]{
